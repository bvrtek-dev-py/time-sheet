from application.modules.user.use_cases.user_get_by_id_use_case import (
    UserGetByIdUseCase,
)
...
class UserUpdateUseCase:
    ...
    async def execute(self, request_dto: UserUpdateDTO, id: str) -> UserDTO:
        user_dto = await self._get_by_id_use_case.execute(id)
